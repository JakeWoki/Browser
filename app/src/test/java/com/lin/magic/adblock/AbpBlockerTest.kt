...
import com.lin.magic.adblock.AbpBlocker.Companion.getQueryParameterMap
import com.lin.magic.adblock.AbpBlockerManager.Companion.blockerPrefixes
import com.lin.magic.adblock.AbpBlockerManager.Companion.isModify
...
class AbpBlockerTest {
    ...
    private val mimeTypeMap = com.lin.magic.adblock.loadMimeTypeMap()
    ...
    private fun request(
        ...
        return com.lin.magic.adblock.TestWebResourceRequest(
            url.toUri(),
            mainFrame,
            headers
    ...
    private fun WebResourceRequest.getContentRequest(pageUri: Uri) =
        ContentRequest(url, pageUri.host, getContentType(pageUri),
            com.lin.magic.adblock.is3rdParty(url, pageUri), requestHeaders, "GET")
