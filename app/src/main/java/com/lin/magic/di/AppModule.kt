...
import com.lin.magic.extensions.portraitSharedPreferencesName
...
import com.lin.magic.html.incognito.IncognitoPageReader
...
class AppModule {
    ...
    fun providesSuggestionsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, com.lin.magic.utils.FileUtils.megabytesToBytes(1)))
