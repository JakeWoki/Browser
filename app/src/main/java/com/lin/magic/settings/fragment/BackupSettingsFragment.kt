...
import com.lin.magic.bookmark.LegacyBookmarkImporter
import com.lin.magic.bookmark.NetscapeBookmarkFormatImporter
...
class BackupSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun addPreferenceSessionExport(aSession: Session) {
        ...
        pref.onPreferenceClickListener = Preference.OnPreferenceClickListener {
            ...
            //startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://crowdin.com/project/magic-web-browser")))
    ...
    private fun showExportBookmarksDialog() : Boolean {
        ...
        val intent = Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                //content://com.android.externalstorage.documents/document/primary%3AAndroid%2Fdata%2Fnet.slions.magic.full.fdroid.debug%2Ffiles%2Fbookm
                // Docs URI looks like: content://com.android.externalstorage.documents/document/primary%3AMagicBookmarksExport.txt
                ...
                // Not working:
                //val uri = DocumentsContract.buildDocumentUri(AUTHORITY_DOWNLOADS,  "/MagicBookmarksExport.txt")

                // Not working:
                //val uri = DocumentsContract.buildDocumentUri(AUTHORITY_DOWNLOADS, ROOT_ID_DOWNLOADS + ":MagicBookmarksExport.txt")

                // Not working: content://com.android.providers.downloads.documents/document/downloads%2FMagicBookmarksExport.txt
                //val uri = DocumentsContract.buildDocumentUri(AUTHORITY_DOWNLOADS, ROOT_ID_DOWNLOADS + "/MagicBookmarksExport.txt")

                // Not working
                //val uri = DocumentsContract.buildDocumentUri(AUTHORITY_DOWNLOADS, "raw:MagicBookmarksExport.txt")
                ...
                //val uri = Uri.fromFile(File(context?.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).toString() + "/MagicBookmarksExport.txt") )
        ...
        putExtra(Intent.EXTRA_TITLE, "MagicBookmarks$timeStamp.txt")
        }
