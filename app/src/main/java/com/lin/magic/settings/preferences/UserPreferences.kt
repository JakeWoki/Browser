...
import com.lin.magic.adblock.AbpUpdateMode
import com.lin.magic.browser.*
import com.lin.magic.constant.DEFAULT_ENCODING
import com.lin.magic.constant.Uris
import com.lin.magic.device.ScreenSize
import com.lin.magic.di.UserPrefs
import com.lin.magic.settings.preferences.delegates.*
...
import com.lin.magic.view.RenderingMode
import android.content.SharedPreferences
import com.lin.magic.browser.ProxyChoice
import com.lin.magic.browser.SuggestionNumChoice
import com.lin.magic.enums.LogLevel
...
import com.lin.magic.settings.preferences.delegates.floatResPreference
import com.lin.magic.settings.preferences.delegates.intPreference
import com.lin.magic.settings.preferences.delegates.stringPreference
...
class UserPreferences @Inject constructor(
     ...
     */
    var downloadDirectory by preferences.stringPreference(DOWNLOAD_DIRECTORY, com.lin.magic.utils.FileUtils.DEFAULT_DOWNLOAD_PATH)
    ...
    var useAccent by preferences.enumPreference(R.string.pref_key_accent, com.lin.magic.AccentTheme.DEFAULT_ACCENT)
