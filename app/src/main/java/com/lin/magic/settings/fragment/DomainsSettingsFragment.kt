...
import com.lin.magic.extensions.reverseDomainName
...
class DomainsSettingsFragment : AbstractSettingsFragment() {
    ...
    fun populateDomainList(view: View) {
        ...
        prefDefault.order = 5
        prefDefault.fragment = "com.lin.magic.settings.fragment.DomainSettingsFragment"
        ...
        if (directory.exists() && directory.isDirectory) {
            ...
            list?.forEach {
                view.postDelayed({
                    ...
                    pref.fragment = "com.lin.magic.settings.fragment.DomainSettingsFragment"
