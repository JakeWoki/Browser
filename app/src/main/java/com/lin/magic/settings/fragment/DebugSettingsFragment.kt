...
import com.lin.magic.extensions.findViewByType
import com.lin.magic.extensions.onceOnLayoutChange
...
import com.lin.magic.utils.Utils.startActivityForFolder
...
class DebugSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCrashLogsFolder() {
        startActivityForFolder(context, com.lin.magic.utils.FileUtils.getFolderCrashLogs().absolutePath)
    }
