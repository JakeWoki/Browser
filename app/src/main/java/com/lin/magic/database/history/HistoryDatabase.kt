...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(com.lin.magic.database.history.HistoryDatabase.KEY_URL, url)
        put(com.lin.magic.database.history.HistoryDatabase.KEY_TITLE, title)
        put(com.lin.magic.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }
