...
import com.lin.magic.adblock.UnifiedFilterResponse
import com.lin.magic.database.adblock.UserRulesRepository.Companion.RESPONSE_BLOCK
import com.lin.magic.database.adblock.UserRulesRepository.Companion.RESPONSE_EXCLUSION
import com.lin.magic.database.adblock.UserRulesRepository.Companion.RESPONSE_NOOP
...
class UserRulesDatabase @Inject constructor(
    ...
    private fun UnifiedFilterResponse.toContentValues() = ContentValues(10).apply {
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_RESPONSE, response.toInt())
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_PATTERN, filter.pattern)
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_FILTER_TYPE, filter.filterType)
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_CONTENT_TYPE, filter.contentType)
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_THIRD_PARTY, filter.thirdParty)
        put(com.lin.magic.database.adblock.UserRulesDatabase.KEY_DOMAIN_MAP, filter.domains?.toDBString() ?: "")
    }
