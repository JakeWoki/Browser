...
package com.lin.magic.constant
...
object Uris {
    const val MagicHome = "${Schemes.Magic}://${Hosts.Home}"
    const val MagicStart = "${Schemes.Magic}://${Hosts.Start}"
    const val MagicIncognito = "${Schemes.Magic}://${Hosts.Incognito}"
    const val MagicBookmarks = "${Schemes.Magic}://${Hosts.Bookmarks}"
    const val MagicDownloads = "${Schemes.Magic}://${Hosts.Downloads}"
    const val MagicHistory = "${Schemes.Magic}://${Hosts.History}"
    const val MagicNoop = "${Schemes.Magic}://${Hosts.Noop}"
