...
import com.lin.magic.extensions.getDrawable
import com.lin.magic.extensions.getText
import com.lin.magic.extensions.ihs
import com.lin.magic.extensions.makeSnackbar
import com.lin.magic.extensions.resizeAndShow
import com.lin.magic.extensions.setIcon
...
import com.lin.magic.settings.NoYesAsk
...
import com.lin.magic.view.WebPageTab.Companion.KFetchMetaThemeColorTries
...
//    private var elementHide = userPreferences.elementHide
     ...
     * Looks like we need to intercept our custom URLs here to implement support for magic and about scheme.
