...
import com.lin.magic.settings.preferences.userAgent
import com.lin.magic.settings.preferences.webViewEngineVersionDesktop
...
import com.lin.magic.enums.LayerType
...
class WebPageTab(
    ...
    val proxyUtils: com.lin.magic.utils.ProxyUtils = hiltEntryPoint.proxyUtils
    ...
    private fun destroyDownloadListener() {
        //See: https://console.firebase.google.com/project/magic-b1f69/crashlytics/app/android:net.slions.magic.full.playstore/issues/ea99c7ea0c57f66eae6e95532a16859d
    ...
    fun loadHomePage() {
        if (isIncognito) {
            iTargetUrl = Uri.parse(Uris.MagicIncognito)
            initializeContent(incognitoPageInitializer)
        } else {
            iTargetUrl = Uri.parse(Uris.MagicHome)
    ...
    fun loadBookmarkPage() {
        iTargetUrl = Uri.parse(Uris.MagicBookmarks)
    ...
    fun loadDownloadsPage() {
        iTargetUrl = Uri.parse(Uris.MagicDownloads)
     ...
     */
    fun loadHistoryPage() {
        iTargetUrl = Uri.parse(Uris.MagicHistory)
    ...
    private fun WebView.initializeSettings() {
        settings.apply {
            ...
            // See: https://github.com/Slion/Magic/issues/82
    ...
    fun loadUrl(aUrl: String) {
        ...
        if (iTargetUrl.scheme == Schemes.Magic || iTargetUrl.scheme == Schemes.About) {
    ...
    companion object {
        ...
        private val SCROLL_UP_THRESHOLD = com.lin.magic.utils.Utils.dpToPx(10f)
        private val SCROLL_DOWN_THRESHOLD = com.lin.magic.utils.Utils.dpToPx(30f)
