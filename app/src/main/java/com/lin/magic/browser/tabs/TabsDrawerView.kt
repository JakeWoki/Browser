...
import com.lin.magic.databinding.TabDrawerViewBinding
import com.lin.magic.di.configPrefs
import com.lin.magic.extensions.inflater
import com.lin.magic.utils.ItemDragDropSwipeHelper
import com.lin.magic.utils.fixScrollBug
...
class TabsDrawerView @JvmOverloads constructor(
    ...
    init {
        ...
        iBinding.tabsList.apply {
            ...
            // See: https://github.com/Slion/Magic/issues/212
