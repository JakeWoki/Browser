...
import com.lin.magic.extensions.invert
import com.lin.magic.extensions.pad
import com.lin.magic.extensions.safeUse
import com.lin.magic.utils.getFilteredColor
...
class FaviconModel @Inject constructor(
    ...
    private val faviconCache = object : LruCache<String, Bitmap>(com.lin.magic.utils.FileUtils.megabytesToBytes(1).toInt()) {
    ...
    fun createDefaultBitmapForTitle(title: String?): Bitmap {
        ...
        @ColorInt val defaultFaviconColor = com.lin.magic.utils.DrawableUtils.characterToColorHash(firstTitleCharacter, application)

        return com.lin.magic.utils.DrawableUtils.createRoundedLetterImage(
            firstTitleCharacter,
            bookmarkIconSize,
            bookmarkIconSize,
            defaultFaviconColor
