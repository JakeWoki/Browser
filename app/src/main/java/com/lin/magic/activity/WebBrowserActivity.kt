...
import com.lin.magic.browser.MenuMain
import com.lin.magic.browser.MenuWebPage
import com.lin.magic.browser.RecentTabsModel
import com.lin.magic.browser.TabModelFromBundle
import com.lin.magic.browser.TabsManager
import com.lin.magic.browser.TabsView
import com.lin.magic.browser.WebBrowser
import com.lin.magic.browser.bookmarks.BookmarksDrawerView
import com.lin.magic.browser.cleanup.ExitCleanup
import com.lin.magic.browser.sessions.SessionsPopupWindow
import com.lin.magic.browser.tabs.TabsDesktopView
import com.lin.magic.browser.tabs.TabsDrawerView
...
import com.lin.magic.databinding.ActivityMainBinding
import com.lin.magic.databinding.ToolbarContentBinding
import com.lin.magic.di.DatabaseScheduler
import com.lin.magic.di.DiskScheduler
import com.lin.magic.di.MainHandler
import com.lin.magic.di.MainScheduler
import com.lin.magic.di.PrefsLandscape
import com.lin.magic.di.PrefsPortrait
import com.lin.magic.di.configPrefs
import com.lin.magic.di.updateConfigPrefs
...
import com.lin.magic.enums.HeaderInfo
import com.lin.magic.extensions.canScrollVertically
import com.lin.magic.extensions.configId
import com.lin.magic.extensions.copyToClipboard
import com.lin.magic.extensions.dimen
import com.lin.magic.extensions.drawable
import com.lin.magic.extensions.drawableForState
import com.lin.magic.extensions.isDarkTheme
import com.lin.magic.extensions.isVirtualKeyboardVisible
import com.lin.magic.extensions.makeSnackbar
import com.lin.magic.extensions.onFocusLost
import com.lin.magic.extensions.onSizeChange
import com.lin.magic.extensions.onceOnScrollStateIdle
import com.lin.magic.extensions.px
import com.lin.magic.extensions.removeFromParent
import com.lin.magic.extensions.resetTarget
import com.lin.magic.extensions.resizeAndShow
import com.lin.magic.extensions.setGravityBottom
import com.lin.magic.extensions.setGravityTop
import com.lin.magic.extensions.setStatusBarIconsColor
import com.lin.magic.extensions.simulateTap
import com.lin.magic.extensions.snackbar
import com.lin.magic.extensions.tint
...
import com.lin.magic.keyboard.Shortcuts
import com.lin.magic.locale.LocaleUtils
import com.lin.magic.notifications.IncognitoNotification
import com.lin.magic.search.SearchEngineProvider
import com.lin.magic.search.SuggestionsAdapter
import com.lin.magic.setAnalyticsCollectionEnabled
import com.lin.magic.setCrashlyticsCollectionEnabled
import com.lin.magic.settings.NewTabPosition
import com.lin.magic.settings.fragment.BottomSheetDialogFragment
import com.lin.magic.settings.fragment.DisplaySettingsFragment.Companion.MAX_BROWSER_TEXT_SIZE
import com.lin.magic.settings.fragment.DisplaySettingsFragment.Companion.MIN_BROWSER_TEXT_SIZE
import com.lin.magic.settings.fragment.SponsorshipSettingsFragment
import com.lin.magic.ssl.SslState
import com.lin.magic.ssl.createSslDrawableForState
import com.lin.magic.ssl.showSslDialog
import com.lin.magic.utils.DrawableUtils
import com.lin.magic.utils.ProxyUtils
import com.lin.magic.utils.QUERY_PLACE_HOLDER
import com.lin.magic.utils.StyleRemovingTextWatcher
import com.lin.magic.utils.ThemeUtils
import com.lin.magic.utils.Utils
import com.lin.magic.utils.WebUtils
import com.lin.magic.utils.adjustBottomSheet
import com.lin.magic.utils.foregroundColorFromBackgroundColor
import com.lin.magic.utils.isBookmarkUri
import com.lin.magic.utils.isBookmarkUrl
import com.lin.magic.utils.isDownloadsUrl
import com.lin.magic.utils.isHistoryUri
import com.lin.magic.utils.isHomeUri
import com.lin.magic.utils.isIncognitoUri
import com.lin.magic.utils.isSpecialUrl
import com.lin.magic.utils.shareUrl
import com.lin.magic.utils.smartUrlFilter
import com.lin.magic.view.BookmarkPageInitializer
import com.lin.magic.view.CodeView
import com.lin.magic.view.DownloadPageInitializer
import com.lin.magic.view.FreezableBundleInitializer
import com.lin.magic.view.HistoryPageInitializer
import com.lin.magic.view.HomePageInitializer
import com.lin.magic.view.IncognitoPageInitializer
import com.lin.magic.view.NoOpInitializer
import com.lin.magic.view.PullRefreshLayout
import com.lin.magic.view.ResultMessageInitializer
import com.lin.magic.view.SearchView
import com.lin.magic.view.UrlInitializer
import com.lin.magic.view.WebPageTab
import com.lin.magic.view.WebViewEx
...
abstract class WebBrowserActivity : ThemedBrowserActivity(),
    WebBrowser, View.OnClickListener, PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    private val longPressBackRunnable = Runnable {
        ...
        // See: https://github.com/Slion/Magic/issues/81
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       iPlaceHolder = Space(this).apply{ isVisible = false}
        ...
        if (app.justStarted) {
            ...
            // See: https://github.com/Slion/Magic/issues/106
            performExitCleanUp()
        }
        ...
        if (BuildConfig.FLAVOR.contains("slionsFullDownload")) {
            ...
            makeSnackbar("",5000, Gravity.TOP).setAction("Powered by ⚡Magic") {
                Intent(Intent.ACTION_VIEW).apply{
                    data = Uri.parse(getString(R.string.url_magic_home_page))
...
//        }
    ...
    private fun createBottomSheetDialog(aContentView: View) : BottomSheetDialog {
        ...
        // Fix for https://github.com/Slion/Magic/issues/226
...
//            }
    ...
    private inner class SearchListenerClass : View.OnKeyListener,
    ...
    private fun tabSwitchStop()
    {
        iCapturedRecentTabsIndices?.let {
            ...
            // See: https://github.com/Slion/Magic/issues/56
    ...
    // https://github.com/Slion/Magic/issues/484
     ...
     * See: https://github.com/Slion/Magic/issues/402
     */
...
//                }
    ...
    override fun onResume() {
        ...
        if (userPreferences.lockedDrawers
                ...
                // See: https://github.com/Slion/Magic/issues/192
                || userPreferences.useBottomSheets
        ) {
            lockDrawers()
        }
    ...
    override fun updateUrl(url: String?, isLoading: Boolean) {
        ...
        if (!searchView.hasFocus()) {
            ...
            // Filter deactivation was introduce to prevent https://github.com/Slion/Magic/issues/557
...
//                    i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                ...
                Response.Listener<JSONObject> { response ->
                    ...
                    if (latestVersion != BuildConfig.VERSION_NAME) {
                        ...
                        makeSnackbar(
                                ...
                                .setAction(R.string.show, View.OnClickListener {
                                    val url = getString(R.string.url_app_home_page)
                                    val i = Intent(Intent.ACTION_VIEW)
                                    i.data = Uri.parse(url)
                                    // Not sure that does anything
    ...
    lateinit var iShortcuts: Shortcuts
