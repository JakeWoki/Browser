...
import com.lin.magic.extensions.toBitmap
...
abstract class ThemedActivity : LocaleAwareActivity() {
    ...
    protected var accentId: com.lin.magic.AccentTheme = userPreferences.useAccent
    ...
    protected open fun provideAccentThemeOverride(): com.lin.magic.AccentTheme? = null
    ...
    @StyleRes
    protected open fun accentStyle(accentTheme: com.lin.magic.AccentTheme): Int? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        // Set the theme before onCreate otherwise settings are broken
        // That's apparently not an issue specific to Magic
        applyTheme(provideThemeOverride()?:themeId)
        applyAccent()
        // NOTE: https://github.com/Slion/Magic/issues/308
