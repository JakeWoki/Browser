...
/**
 * We used that to transition after our major refactoring moved all classes to magic package.
 *
...
class ClassLoaderCompat(parent: ClassLoader) :
    ...
    override fun loadClass(name: String): Class<*>? {
        ...
        return if (name == "acr.browser.lightning.browser.sessions.Session") {
            ...
            com.lin.magic.browser.sessions.Session::class.java
        } else {
    ...
    */
    ...
    override fun findClass(name: String?): Class<*> {
        ...
        return if (name == "acr.browser.lightning.browser.sessions.Session") {
            ...
            com.lin.magic.browser.sessions.Session.javaClass
        } else {
