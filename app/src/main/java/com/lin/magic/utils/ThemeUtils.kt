...
object ThemeUtils {
    ...
    fun getSearchBarColor(requestedColor: Int): Int {
        ...
        return if (luminance > 0.9) {
            ...
            com.lin.magic.utils.DrawableUtils.mixColor(0.20f, requestedColor, Color.BLACK)
        } else {
            // Make search text field background lighter
            com.lin.magic.utils.DrawableUtils.mixColor(0.20f, requestedColor, Color.WHITE)
        }
    }
    ...
    fun getSearchBarFocusedColor(requestedColor: Int): Int {
        ...
        return if (luminance > 0.9) {
            // Too bright, make it darker then
            com.lin.magic.utils.DrawableUtils.mixColor(0.35f, requestedColor, Color.BLACK)
        } else {
            // Make search text field background lighter
            com.lin.magic.utils.DrawableUtils.mixColor(0.35f, requestedColor, Color.WHITE)
        }
    }
