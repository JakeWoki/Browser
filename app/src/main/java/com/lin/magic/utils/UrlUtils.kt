...
import com.lin.magic.constant.Schemes
...
fun String?.isBookmarkUri(): Boolean =
    this == Uris.MagicBookmarks || this == Uris.AboutBookmarks
...
fun String?.isHomeUri(): Boolean =
    this == Uris.MagicHome || this == Uris.AboutHome
...
fun String?.isIncognitoUri(): Boolean =
    this == Uris.MagicIncognito || this == Uris.AboutIncognito
...
fun String?.isHistoryUri(): Boolean =
    this == Uris.MagicHistory || this == Uris.AboutHistory
...
private val ACCEPTED_URI_SCHEMA = Pattern.compile("(?i)((?:http|https|file)://|(?:inline|data|about|javascript|magic):|(?:.*:.*@))(.*)")
