...
import com.lin.magic.Sponsorship
...
class SponsorshipSettingsFragment : AbstractSettingsFragment(),
    ...
    private fun populatePreferenceScreenStaticItems() {
        ...
        // Add preference with link to Magic download page
        addPreferenceLinkToMagicHome()
    }
     ...
     *
     */
    private fun addPreferenceLinkToMagicHome() {
